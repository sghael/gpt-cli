...
class MarkdownElement:
    ...
    @classmethod
    def create(cls, markdown: "CustomMarkdown", token: Token) -> "MarkdownElement":
...
class Paragraph(TextElement):
    ...
    @classmethod
    def create(cls, markdown: "CustomMarkdown", token: Token) -> "Paragraph":
...
class Heading(TextElement):
    ...
    @classmethod
    def create(cls, markdown: "CustomMarkdown", token: Token) -> "Heading":
...
class CodeBlock(TextElement):
    ...
    @classmethod
    def create(cls, markdown: "CustomMarkdown", token: Token) -> "CodeBlock":
...
class ListElement(MarkdownElement):
    ...
    @classmethod
    def create(cls, markdown: "CustomMarkdown", token: Token) -> "ListElement":
...
class CustomMarkdown(JupyterMixin):
